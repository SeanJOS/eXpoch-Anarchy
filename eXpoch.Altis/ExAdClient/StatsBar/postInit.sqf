...
if(isNil "ExAd_SB_Toggle_Temp_Default")then{ExAd_SB_Toggle_Temp_Default = true;};
...

{
	...
	["STR_ExAd_SB_APP_TOGGLE_TEMP", "Toggle Temperature Type(C/F)"],
...
ExAd_SB_Toggle_Temp = profileNamespace getVariable ["ExAd_SB_Toggle_Temp", ExAd_SB_Toggle_Temp_Default];
