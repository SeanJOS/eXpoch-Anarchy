...
_cbTemp = [_display,_newParent,([_slideClass,"cbToggleTemp"] call ExAd_fnc_getNextIDC),[_rightCol, _cbCompTop + _rowH * 8, _cbW, _cbH],"ExAd_SB_Toggle_Temp = !ExAd_SB_Toggle_Temp;call ExileClient_gui_hud_toggleDPXTemp",""] call ExAd_fnc_createCheckBox;
[_display,_newParent,([_slideClass,"strTxtToggleTemp"] call ExAd_fnc_getNextIDC),[_rightCbStr, _cbCompTop + _rowH * 8, _cbStrW, _rowH],STR_ExAd_SB_APP_TOGGLE_TEMP,_cbStrTextFont,_cbStrTextSize,_cbStrTextColor,_cbStrAlign,1] call ExAd_fnc_createStructuredText;
if(ExileClientPlayerUSATemp isEqualTo 1)then{
	_cbTemp cbSetChecked ExAd_SB_Toggle_Temp;
}else{
	_cbTemp cbSetChecked !ExAd_SB_Toggle_Temp;
};
_cbHUD = [_display,_newParent,([_slideClass,"cbShowHUD"] call ExAd_fnc_getNextIDC),[_rightCol, _cbCompTop + _rowH * 7, _cbW, _cbH],"ExAd_SB_EXILE_HUD_ACTIVE = !ExAd_SB_EXILE_HUD_ACTIVE;call ExileClient_gui_hud_toggleDPXHUD",""] call ExAd_fnc_createCheckBox;
