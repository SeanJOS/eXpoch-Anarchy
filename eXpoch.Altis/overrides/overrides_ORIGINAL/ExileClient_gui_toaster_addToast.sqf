...
private["_rawText","_stripeColor","_display","_toastControl","_toastPosition","_textControl","_textHeight","_textPosition","_backgroundControl","_backgroundPosition","_stripeControl","_stripePosition","_toastDelay"];
...
_toastDelay = getNumber(missionConfigFile >> "CfgeXpoch" >> "ToastDeleteDelay");
ExileClientToasts pushBack [_toastControl, 0, diag_tickTime + _toastDelay]; //5];
reverse ExileClientToasts;
