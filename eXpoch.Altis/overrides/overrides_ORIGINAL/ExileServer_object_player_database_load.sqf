...
diag_log format["ACE %1",_loadAceStats];
...
/*
//DPCG
_player setVariable ["ExileZedKills", (_data select 47), true];
_player setVariable ["ryanzombiesinfected", (_data select 48), true];
if((_data select 48) > 0)then
{
	[_player,side _group, ""] execVM "\eXpoch_multifix\persistentInfection.sqf";
};
_player setVariable ["ExileAIKills", (_data select 49), true];
_player setVariable ["ExileHeals", (_data select 50), true];
_player setVariable ["ExileRevives", (_data select 51), true];
_player setVariable ["ExileBlood", (_data select 52), true];
_player setVariable ["ExileTimeAlive", (_data select 53), true];
_player setVariable ["ExileTimeAliveLastCheck", diag_tickTime,true];
_player setVariable ["ExileDMS", (_data select 54), true];
_player setVariable ["ExileZCP", (_data select 55), true];
_player setVariable ["ExileVEMF", (_data select 56), true];
*/
//ace persistance
//basic
