...
private["_playerNetID","_scoreString","_kills","_deaths","_hunger","_thirst","_alcohol","_clanData","_temperature","_wetness","_player","_zedKills","_zedInfection","_aiKills","_heals","_revives","_loadAceStats","_loadAccountStats","_loadAccountStatsArray"];
...
/*
//DPCG
_zedKills = _this select 10;
_zedInfection = _this select 11;
_aiKills = _this select 12;
_heals = _this select 13;
_revives = _this select 14;
_blood = _this select 15;
_timeAlive = _this select 16;
_dmsCaptures = _this select 17;
_zcpCaptures = _this select 18;
_loadAceStats = _this select 19;
