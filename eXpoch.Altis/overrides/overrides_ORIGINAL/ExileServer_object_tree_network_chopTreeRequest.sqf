...
private["_sessionId","_parameters","_treeNetId","_tree","_isTree","_player","_treeHeight","_newDamage","_treePosition","_spawnRadius","_weaponHolders","_weaponHolder","_weaponHolderPosition","_logs","_logType"];
...
try 
{
	...
	//_logs = ["Exile_Item_WoodLog","eXpoch_WoodLog_EPOCH"];
	//_logType = selectRandom(_logs);
