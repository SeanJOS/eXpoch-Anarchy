 ...
 *
 * Exile Mod modified by DirtySanchez for the Exile and eXpoch Community
...
if !(ExileClientCurrentInventoryContainer isKindOf "man") then
{
	...
	{
		_configContainer = getNumber(missionConfigFile >> "CfgeXpoch" >> "ContainerMaxPopTabsMultiplier");
		_maximumCapacity = _maximumLoad * _configContainer;// 10;
