	...
	switch (_itemClassName) do 
	{
		case "rzinfection_antivirus_injector": 
		{
			...
			player spawn 
			{
				...
				sleep 30;
				_ppInfInjEnd = ppEffectCreate ["ChromAberration", 0];
				_ppInfInjEnd ppEffectAdjust [0, 0, false];
				_ppInfInjEnd ppEffectCommit 2;
				if(!isNil "_ppInfInjYes")then
				{
					[_ppInfInjYes,_ppInfInjEnd] ppEffectEnable false;
					ppEffectDestroy [_ppInfInjYes,_ppInfInjEnd];
				};
				if(!isNil "_ppInfInjNo")then
				{
					[_ppInfInjNo,_ppInfInjEnd,_ppInfInjNo2,_ppInfInjNo3,_ppInfInjNo4,_ppInfInjNo5,_ppInfInjNo6] ppEffectEnable false;
					ppEffectDestroy [_ppInfInjNo,_ppInfInjEnd,_ppInfInjNo2,_ppInfInjNo3,_ppInfInjNo4,_ppInfInjNo5,_ppInfInjNo6];
				};
		...
		case "rzinfection_antivirus_pills": 
		{
			...
			player spawn
			{
				...
				_ppInfPillEnd = ppEffectCreate ["ChromAberration", 0];
				_ppInfPillEnd ppEffectAdjust [0, 0, false];
				_ppInfPillEnd ppEffectCommit 2;
				if(!isNil "_ppInfPillYes")then
				{
					[_ppInfPillYes,_ppInfPillEnd] ppEffectEnable false;
					ppEffectDestroy [_ppInfPillYes,_ppInfPillEnd];
				};
				if(!isNil "_ppInfPillNo")then
				{
					[_ppInfPillNo,_ppInfPillEnd,_ppInfPillNo2,_ppInfPillNo3,_ppInfPillNo4] ppEffectEnable false;
					ppEffectDestroy [_ppInfPillNo,_ppInfPillEnd,_ppInfPillNo2,_ppInfPillNo3,_ppInfPillNo4];
				};
...
/* eXpoch New Addition */
//eXpochACE consume upgrades
if(_itemClassName isEqualTo "Exile_Item_InstaDoc")then{[player,player] call ace_medical_fnc_treatmentAdvanced_fullHeal;};
