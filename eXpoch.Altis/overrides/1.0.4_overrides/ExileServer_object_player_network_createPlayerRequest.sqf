...
private["_sessionID", "_parameters", "_requestingPlayer", "_spawnLocationMarkerNameArray", "_playerUID", "_accountData", "_bambiPlayer", "_cargoType"];
...
try
{
	...
	_spawnLocationMarkerNameArray = _parameters select 0;
	...
	[_sessionID, _requestingPlayer, _spawnLocationMarkerNameArray, _bambiPlayer, _accountData] call ExileServer_object_player_createBambi;
}
catch
{
