...
_ownTerritory = player call ExileClient_util_world_isInOwnTerritory;
if!(_ownTerritory)exitWith{["ErrorTitleAndText", ["Failed to access!", "You can only use a Locker at base, USE ATMs for public banking"]] call ExileClient_gui_toaster_addTemplateToast;};
