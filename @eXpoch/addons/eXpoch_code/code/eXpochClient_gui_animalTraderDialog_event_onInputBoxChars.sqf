/*
	eXpochClient_gui_animalTraderDialog_event_onInputBoxChars
...
*/
private["_inputBox","_character","_dialog","_purchaseButton","_animalClass","_salesPrice","_quality","_requiredRespect","_ctrlText"];
...
_animalClass = uiNamespace getVariable ["RscExileAnimalTraderDialogAnimalClass",""];
...
{
	if!(_animalClass isEqualTo "")then
	{
