/**
 * ExileClient_gui_vehicleCustomsDialog_show_bandit
 *
 * Exile Mod
 * www.exilemod.com
 * © 2015 Exile Mod Team
...
private["_traderObject","_localVehicles","_nearVehicles","_customizableVehicles","_parentClassName","_dialog","_vehicleDropDown","_vehicleObject","_vehicleIndex","_configBanditRank","_configBanditName"];
