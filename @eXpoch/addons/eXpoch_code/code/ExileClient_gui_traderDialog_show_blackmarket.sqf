/**
 * ExileClient_gui_traderDialog_show_blackmarket
 *
 * Exile Mod
 * www.exilemod.com
 * © 2015 Exile Mod Team
...
private["_dialog","_traderName","_primaryWeaponCheckbox","_handgunCheckbox","_storeDropdown","_storeDropdownSize","_quantityDropdown","_purchaseButton","_sellButton", "_configBlackMarketRank"];
...
if ((eXpochClientPlayerRank >= _configBlackMarketRank) || (eXpochClientPlayerRank <= -(_configBlackMarketRank)))then
{
	...
	call ExileClient_gui_traderDialog_updateStoreListBox_blackmarket;
