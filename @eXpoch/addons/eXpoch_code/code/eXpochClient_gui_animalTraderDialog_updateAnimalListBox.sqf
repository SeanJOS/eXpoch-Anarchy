/*
	eXpochClient_gui_animalTraderDialog_updateAnimalListBox
...
*/
private["_dialog","_categoryClasses","_itemListControl","_categoryClass","_categoryAnimalClassNames","_className","_salesPrice","_indexEntryIndex","_playerMoney","_quality","_requiredRespect","_qualityColor","_popTabColor","_missingPopTabs","_missingRespect"];
...
{
	_categoryClass = _x;
	_categoryAnimalClassNames = getArray(missionConfigFile >> "CfgTraderCategories" >> _categoryClass >> "items");
	{
		_className = _x;
	...
	forEach _categoryAnimalClassNames;
}
